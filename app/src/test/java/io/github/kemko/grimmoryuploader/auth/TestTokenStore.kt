...
class TestTokenStore : TokenStore, OidcPendingStore {
    ...
    override suspend fun writePendingOidc(request: OidcPendingRequest) { pending = request }
    override suspend fun clearPendingOidc() { pending = null }
}
